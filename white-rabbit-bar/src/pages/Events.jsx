...
const events = [
  {
    ...
    date: 'AUG 1',
    day: 'FRIDAY',
    title: "WHITE RABBIT 17TH ANNIVERSARY",
    desc: 'ครบรอบ 17 ปี White Rabbit Bar Silom — คืนพิเศษที่สุดของปี เฉลิมฉลองกับครอบครัว White Rabbit ที่สีลม ซอย 2 กรุงเทพฯ',
    time: '20:00 – 04:00',
